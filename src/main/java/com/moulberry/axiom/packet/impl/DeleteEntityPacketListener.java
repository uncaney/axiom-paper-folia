...
public class DeleteEntityPacketListener implements PacketHandler {
    ...
    public void onReceive(Player player, RegistryFriendlyByteBuf friendlyByteBuf) {
        ...
        for (UUID uuid : delete) {
            ...
            // Folia: dispatch removal to the entity's owning region thread.
            bukkitEntity.getScheduler().run(this.plugin, task -> {
                Entity entity = serverLevel.getEntity(uuid);
                if (entity == null || entity instanceof net.minecraft.world.entity.player.Player || entity.hasPassenger(e -> e instanceof net.minecraft.world.entity.player.Player)) return;
